...
public interface IDocxRenderer
{
    ...
    Drawing InsertImage(Paragraph currentParagraph, MarkdownObject source, string imageUrl, string altText, string title, bool hasBorder, string lightboxImageUrl);
